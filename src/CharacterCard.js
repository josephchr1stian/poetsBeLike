...
export default function CharacterCard(props) {
  ...
  const[poemImage, setPoemImage] = useState("https://picsum.photos/300?grayscale&blur=3")
  ...
  function setImage(){
    ...
    console.log("https://picsum.photos/300?grayscale&blur="+ toString(blurLevel))
    setPoemImage("https://picsum.photos/300?grayscale&blur="+ toString(blurLevel))
